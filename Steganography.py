...
Label(root,text="MKCE STEGANOGRAPHY",bg="#2d4155",fg="white",font="arial 25 bold").place(x=100,y=20)
...
#Fifth Frame
frame5=Frame(root,bd=3,bg="#2f4155",width=270,height=400,relief=GROOVE)
frame5.place(x=709,y=70)
